...
(function () {
    ...
    function debut() {
        ...
        choixTP.append($("<h3>").html("📚 Travaux Pratiques").css({"margin-top": "0", "color": "var(--primary-color)"}));
        ...
        tpGauche.append($("<button>").addClass("tp-button").html("TP 3 - Analyses complexes").click(function () { lancementTP("TP3"); }));
        
        tpDroite.append($("<button>").addClass("tp-button").html("TP 2 - Requêtes avancées").click(function () { lancementTP("TP2"); }));
        tpDroite.append("<br><br>");
        tpDroite.append($("<button>").addClass("tp-button").html("TP 4 - Modifications de données").click(function () { lancementTP("TP4"); }));
