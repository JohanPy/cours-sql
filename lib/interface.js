...
(function () {
    ...
    function debut() {
        ...
        // Section TP
        var choixTP = $("<div>").attr("id", "choixTP").css("text-align", "center").css("margin-top", "20px").css("clear", "both");
        choixTP.append($("<h3>").html("Travaux Pratiques"));
        choixTP.append($("<button>").html("TP 1 - Requêtage simple").click(function () { lancementTP("TP1"); }));
        choixTP.append("<br>");
        choixTP.append($("<button>").html("TP 2 - Requêtes avancées").click(function () { lancementTP("TP2"); }));
        choixTP.append("<br>");
        choixTP.append($("<button>").html("TP 3 - Analyses complexes").click(function () { lancementTP("TP3"); }));
        choixTP.append("<br>");
        choixTP.append($("<button>").html("TP 4 - Modifications de données").click(function () { lancementTP("TP4"); }));
