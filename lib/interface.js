...
import { resolveAliasToTable, parseFromAliases } from './parser.js';
(function () {
    "use strict";
    ...
    function createSqlCompleter() {
        ...
        var completer = {
            getCompletions: function (editor, session, pos, prefix, callback) {
                ...
                debounceTimers.set(key, setTimeout(async function () {
                    ...
                    var fromMap = await parseFromAliases(editorText);
                    if (isDotContext && ident) {
                        ...
                        if (!tableName) {
                            var resolved = await resolveAliasToTable(editorText, ident);
